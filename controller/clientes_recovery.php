...
if(isset($_POST['cli_email'])){
	...
	if($cliente->GetClienteEmail($cliente->getCli_email()) > 0){
		...
		$email = new EnviarEmail();
     	$assunto = 'Nova Senha - ' . $_ENV['SITE_NOME'];
     	$msg = "Olá cliente, uma nova senha foi solicitada por você, acesse o site: " . $_ENV['SITE_NOME'];
     	$msg .= "<br> Nova Senha =  " . $novasenha;
	 	$destinatarios = array($cliente->getCli_email(), $_ENV['SITE_EMAIL_ADM']);
