  ...
  <section class="row" id="dadosfrete">
    ...
    <div class="col-md-4"></div>
      ...
      <div class="col-md-4">
        ...
        <button class="btn btn-warning btn-block" id="buscar_frete">
          <i class="glyphicon glyphicon-send"></i> Calcular
          Frete </button>
      </div>
  ...
  <section class="row" id="total">
    ...
    <div class="col-md-4 ">
      ...
      <form name="pedido_confirmar" id="pedido_confirmar" method="post" action="{$PAG_CONFIRMAR}">
        ...
        <button class="btn btn-success btn-block" type="submit"> <i class="glyphicon glyphicon-ok"></i> Confirmar Pedido
        </button>
